...
int main() {
    ...
    if (avg >= 90.0) {
        ...
        if (avg >= 75.0 && avg < 90.0) {
            printf("Average: %.2f\nGrade: B\n", avg);
        } else {
            if (avg >= 50.0 && avg < 75.0) {
                printf("Average: %.2f\nGrade: C\n", avg);
            } else {
                printf("Average: %.2f\nGrade: F\n", avg);
            }
...
<img width="832" height="438" alt="image" src="https://github.com/user-attachments/assets/f5632a2d-6f26-4f47-b0c1-f5ed489e2de5" />
...
<img width="832" height="405" alt="image" src="https://github.com/user-attachments/assets/f61daca8-61f6-4622-9ff2-da10a04bcf00" />
...
<img width="884" height="284" alt="image" src="https://github.com/user-attachments/assets/b14ace9a-6c88-44cc-9e6e-e646e2b6b89d" />
...
<img width="850" height="320" alt="image" src="https://github.com/user-attachments/assets/d2b7818a-38f9-43ba-88f1-8579646cf360" />
...
<img width="880" height="349" alt="image" src="https://github.com/user-attachments/assets/b498d403-974f-402f-a954-6ff9ea007f92" />
